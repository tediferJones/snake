    ...
    t('div', { className: 'aspect-square w-3/4 grid grid-cols-2 mx-auto rotate-45' /*hidden'*/ }, [
      t('div', {
        ...
        onclick: () => changeDirFunc('ArrowUp')
          ...
          t('div', { className: 'mb-8 mr-8 -rotate-45 w-0 h-0 border-l-[20px] border-r-[20px] border-b-[30px] border-transparent border-b-white' }),
        ]),
      t('div', {
        className: 'aspect-square bg-black m-2 flex justify-center items-center',
        onclick: () => changeDirFunc('ArrowRight')
      }, [
          t('div', { className: 'mb-8 ml-8 rotate-45 w-0 h-0 border-l-[20px] border-r-[20px] border-b-[30px] border-transparent border-b-white' }),
        ]),
      t('div', {
        className: 'aspect-square bg-black m-2 flex justify-center items-center',
        onclick: () => changeDirFunc('ArrowLeft')
      }, [
          t('div', { className: 'mt-8 mr-8 rotate-45 w-0 h-0 border-l-[20px] border-r-[20px] border-t-[30px] border-transparent border-t-white' }),
        ]),
      t('div', {
        className: 'aspect-square bg-black m-2 flex justify-center items-center',
        onclick: () => changeDirFunc('ArrowDown')
      }, [
          t('div', { className: 'mt-8 ml-8 -rotate-45 w-0 h-0 border-l-[20px] border-r-[20px] border-t-[30px] border-transparent border-t-white' }),
        ]),
    ])
  ])
